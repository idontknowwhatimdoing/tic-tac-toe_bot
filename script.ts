...
const analyzeRow = (idStart: number) => {
	let xCount = 0;
...
const analyzeColumn = (idStart: number) => {
	let xCount = 0;
...
const analyzeDiagonal = (idStart: number) => {
	let xCount = 0;
